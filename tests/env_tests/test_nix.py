...
def test_nix_htty_py_sdist_import():
    ...
    result = subprocess.run(
        ["nix", "shell", ".#htty-py-sdist", "--command", "python", "-c", "import htty"],
        capture_output=True,
        text=True,
...
def test_nix_htty_pylib_import():
    ...
    result = subprocess.run(
        ["nix", "shell", ".#htty-pylib", "--command", "python", "-c", "import htty"],
        capture_output=True,
        text=True,
        cwd="/Users/matt/src/ht",
    )
...
def test_nix_htty_pylib_ht_command():
    ...
    result = subprocess.run(
        ["nix", "shell", ".#htty-pylib", "--command", "ht", "--help"],
        capture_output=True,
        text=True,
        cwd="/Users/matt/src/ht",
    )
...
def test_nix_htty_cli_ht_command():
    ...
    result = subprocess.run(
        ["nix", "shell", ".#htty-cli", "--command", "ht", "--help"],
        capture_output=True,
        text=True,
        cwd="/Users/matt/src/ht",
    )
...
def test_nix_htty_pylib_htty_command():
    ...
    result = subprocess.run(
        ["nix", "shell", ".#htty-pylib", "--command", "htty", "--help"],
        capture_output=True,
        text=True,
        cwd="/Users/matt/src/ht",
    )
...
def test_nix_htty_cli_no_python_import():
    ...
    result = subprocess.run(
        ["nix", "shell", ".#htty-cli", "--command", "python", "-c", "import htty"],
        capture_output=True,
        text=True,
        cwd="/Users/matt/src/ht",
    )
...
def test_nix_htty_py_sdist_no_ht_command():
    ...
    result = subprocess.run(
        ["nix", "shell", ".#htty-py-sdist", "--command", "ht", "--help"],
        capture_output=True,
        text=True,
        cwd="/Users/matt/src/ht",
    )
...
def test_nix_htty_py_sdist_no_htty_command():
    ...
    result = subprocess.run(
        ["nix", "shell", ".#htty-py-sdist", "--command", "htty", "--help"],
        capture_output=True,
        text=True,
        cwd="/Users/matt/src/ht",
    )
    ...
    assert "No such file or directory" in result.stderr or "not found" in result.stderr, (
        f"Expected command not found error, got: {result.stderr}"
    )
